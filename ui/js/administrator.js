$(document).ready(function () {
  ...
  function administratorList() {
    ...
    $.ajax({
      url: 'http://a0ba4c0b3af664883a963e282a97e7e0-706098893.us-east-1.elb.amazonaws.com/administrator/getall',
      type: 'POST',
      dataType: 'json',
  ...
  function administratorAdd(administrator) {
    ...
    $.ajax({
      url: "http://a0ba4c0b3af664883a963e282a97e7e0-706098893.us-east-1.elb.amazonaws.com/administrator/new",
      type: 'POST',
